...
function hapusData(arrive_id) {
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url : "<?=site_url('admin/arrive/deletedata')?>/"+id,
            type: "POST",
            dataType: "JSON",
...
<div class="page-content-wrapper">
    <div class="page-content">            
        ...
        <a href="<?=site_url('admin/arrive/adddata'); ?>">
            ...
            <div class="col-md-12">
                <div class="portlet box red-thunderbird">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i> Arrive List
                        </div>
                    </div>
...
$(document).ready(function() {
    table = $('#tableData').DataTable({ 
        ...
        "pageLength": 15,
        "ajax": {
            "url": "<?=site_url('admin/arrive/data_list')?>",
            "type": "POST",
            "data": function(data) {
